              ...
              <div align="right" dir="rtl">
                  ...
                  <ul class="stylee" align="right" style="list-style-type:circle">
                      <u style="color:#0020C2">
                          <b style="color:#0020C2">الأوراق المطلوبه لبدء الدراسة أو المعادلة أو تجديد معادلة درجة علمية
                              ممنوحة من مؤسسة تعليمية داخل ج.م.ع:</b></u>
                      <br>
                      <br>
                      ...
                      5. دراسة الجدوى و خطة الجامعه لتوفير الأمكانيات اللازمه لجودة العملية التعليميه فى حالة بدء
                      الدراسه<br>
                      6. بيانات منسق الجامعه ( الاسم - الوظيفه - الإيميل - رقم التليفون ) لكليات الهندسه <br>
                      7. رفع مايفيد سداد الرسوم المقررة على الكود المؤسسي لأمانة المجلس الأعلى للجامعات رقم 13600201
                      الباب الأول (إيرادات) <br>
...
-->
          ...
          <tr>
              <div align="right" dir="rtl">
                  <p class="stylee" align="right">
                  <ul class="stylee" align="center" style="list-style-type:circle">
          ...
          <tr>
              <div align="right" dir="rtl">
                  <p class="stylee" align="right">
                  <ul class="stylee" align="right" style="list-style-type:circle">
                      <span style="color:#0020C2">
                          <b style="color:#0020C2">التعهد :</b></span>
                      <div style="color:red">
                          <pre>
          ...
          <tr>
              <td>
                  <div align="right"><span class="stylee">
              ...
              <td dir="center" align="center">
                  <div align="center"><span class="stylee">

                          <input type="checkbox" name="formWheelchair" value="Yes" onClick="redirect('new_request.php')"
                              required="" oninvalid="this.setCustomValidity('يجب الموافقة على التعهد')"
          ...
          <tr>
              <td dir="rtl" align="right">
                  <div align="center">
                      <input type="submit" name="formSubmit" value="التسجيل"
                          style="width:8em ;height:2em;font-size:18px;" class="btn btn-info stylee" />
