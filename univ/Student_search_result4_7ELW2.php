...
echo"<br>";
	...
	echo"<br>";
		...
		echo"<br>";
	*/	
  $sql ="SELECT applicant.`Serial` as app_serial $selectt ,`degree`,`FK_matlob`,matlob.matlob_NAME,request.StatusID,request.REQUEST_ID,status.STATUS_VALUE as STATUS_VALUE,request.fk_tawseya
...
echo'<tr>
    ...
    $resqtawseya = $stmtqtawseya->get_result();
		 ...
		 echo'
	  <td class="text-center">'.$rowtawseya['tawseya_NAME'].'</td> ';
		 }
