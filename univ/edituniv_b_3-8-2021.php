...
//echo '--------------------------------------'.$n;
	...
	$q="
	SELECT applicant.`Serial`,applicant.`univ_id`,applicant.`user_role`,applicant.`USER_ID`,applicant.`degree`,applicant.`FK_matlob`,request.`destination`,request.`univ_destination` FROM `applicant`, `request`
			where 
...
//echo '--------------------------------------'.$n;
	...
	?>  
     <form class="form-horizontal" action="update_univ.php" method="post" >
