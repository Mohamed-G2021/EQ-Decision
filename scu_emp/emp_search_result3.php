...
/////////////////////////////////////////////////
    ...
    echo "<div class='paginationContainer'>";
        for ($i = 1; $i <= $total_pages; $i++) {
            ...
            echo '<form method="post" action="' . htmlspecialchars($_SERVER["PHP_SELF"]) . '?page=' . $i . '" class="' . $activeClass . '" style="display: inline-block; margin: 10px 5px;">
                ...
                <input type="submit" name="btnsearch" value="' . $i . '"> 
            </form>';
        }
    echo "</div>";
