...
//////////////////////////////////////////////////////	
	...
	$q="
	SELECT applicant.`Serial`,applicant.`univ_id`,applicant.`USER_ID`,applicant.`degree`,applicant.`fk_degree`,applicant.`FK_matlob`,request.destination,`applicant`.`user_role` ,`request`.`karar`
...
<!------------------------------------------------------------------------------------------------------------>
      ...
      <tr>
        <td dir="rtl"><div align="right">
          <input type="text" name="txtes" id="txtes" style="width:20em ;height:20em;"   maxlength="50000" required=""  value="<?php echo $karar; ?>"  readonly 
 ...
 oninput="setCustomValidity('')"  pattern="^[\u0621-\u064A ]+$" title="حروف فقط غير مسموح باستخدام ارقام" />
        ...
        <td>
		  <div align="right">التوصية او القرار</div>
		</td>
      </tr>
<!------------------------------------------------------------------------------------------------------------>		
<!------------------------------------------------------------------------------------------------------------>		  
...
else
{
   ...
   result5 = pattern.test(txtes);
	...
	{
		 var strr="التوصيه او القرار يجب انيكون باللغة العربيه"
	  alert(strr); 
	}
}
