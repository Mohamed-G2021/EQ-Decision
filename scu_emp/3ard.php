...
//echo '--------------------------------------'.$n;
  ...
  $sql ='SELECT distinct applicant.serial ,applicant.`degree`,applicant.`FK_matlob`,applicant.`fk_degree`,degree.name as degname ,request.REQUEST_ID,request.StatusID,request.`univ_destination`,request.`univ_emkanyat`,request.`univ_gadwa`,`applicant`.`user_role`,applicant.`univ_id`

FROM `applicant`,request,degree
        ...
        $degree=$row['degree'];
		 $FK_matlob=$row['FK_matlob'];
		  $REQUEST_ID=$row['REQUEST_ID'];
		   $StatusID=$row['StatusID'];
	   $destination=$row['univ_destination'];
...
?>	
<form id="form1" name="form1" method="post"  action="3ard_option.php" onsubmit="return checkform(this);" enctype="multipart/form-data" >
<div align="center">
<div align="center" dir="rtl">
<h2 class="stylee">عرض الطلب</h2>
</div>
	<br>
...
<!------------------------------------------------------------------------------------------------------------>
        ...
        <td dir="rtl"><div align="right">
          <select name="txtarname" id="txtarname" required readonly  class="form-control"
...
<!------------------------------------------------------------------------------------------------------------>		  
    <tr>
        <td dir="rtl"><div align="right">
          <select name="degree" id="degree" required  readonly  class="form-control"
                        style="width:12em;font-size: 18px;">
...
<!------------------------------------------------------------------------------------------------------------------------------->
    ...
    <tr>
        <td dir="rtl"><div align="right">
          <input type="text" name="txtorg" id="txtorg" style="width:15.5em" class="form-control"   required=""  value="<?php echo $degree ; ?>" readonly
...
<!------------------------------------------------------------------------------------------------------------>		  
    <tr>
        <td dir="rtl"><div align="right">
          <select name="dplgov" id="dplgov" required  readonly  class="form-control"
                        style="width:12em;font-size: 18px;">
...
{ ?>
  <tr>
		...
		<div align="right">
		 ...
		 <td   align="right" dir="rtl">
     <iframe id="iframepdf" src="<?php echo $univ_emkanyat; ?>" title="PDF in an i-Frame" style="border:1px solid #666CCC" scrolling="auto" height="500" width="500" ></iframe>
...
{ ?>
  <tr>
		...
		<div align="right">
		 ...
		 <td   align="right" dir="rtl">
     <iframe id="iframepdf" src="<?php echo $univ_gadwa; ?>" title="PDF in an i-Frame" style="border:1px solid #666CCC" scrolling="auto" height="500" width="500" ></iframe>
...
?>
	  ...
	  <div align="center">
		<input type="submit" name="action"  value="تم المراجعه" style="width:9em ;height:2em;font-size:18px;" class="btn btn-info stylee"/>
		<input type="submit" name="action"  value="تم المراجعه و يوجد استيفاء" style="width:13em ;height:2em;font-size:18px;" class="btn btn-info stylee"/>
