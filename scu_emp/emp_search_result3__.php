				...
				if($user_role==40)
{
	...
	$wheree="and universty_lookup.id = `applicant`.`univ_id` ";
...
else if($user_role==50)
{
	...
	$wheree="and academy_lookup.id = `applicant`.`univ_id` ";
...
else
{
	...
	$wheree="and institute_lookup.id = `applicant`.`univ_id`  ";
				...
				if($user_role==40)
{
	$selectt=",universty_lookup.name as namee ,universty_lookup.id as idd";
	$fromm=",universty_lookup";
	$wheree="and universty_lookup.id = `applicant`.`univ_id` and status.STATUS_ID=$statusselect ";
...
else if($user_role==50)
{
	$selectt=",academy_lookup.name as namee ,academy_lookup.id as idd";
	$fromm=",academy_lookup";
	$wheree="and academy_lookup.id = `applicant`.`univ_id`  and status.STATUS_ID=$statusselect";
...
else
{
	$selectt=",institute_lookup.name as namee ,institute_lookup.id as idd";
	$fromm=",institute_lookup";
	$wheree="and institute_lookup.id = `applicant`.`univ_id`  and status.STATUS_ID=$statusselect ";
				...
				if($user_role==40)
{
	$selectt=",universty_lookup.name as namee ,universty_lookup.id as idd";
	$fromm=",universty_lookup";
	$wheree="and universty_lookup.id = `applicant`.`univ_id` and  `request`.`REQUEST_ID` = $request ";
...
else if($user_role==50)
{
	$selectt=",academy_lookup.name as namee ,academy_lookup.id as idd";
	$fromm=",academy_lookup";
	$wheree="and academy_lookup.id = `applicant`.`univ_id`  and `request`.`REQUEST_ID` = $request";
...
else
{
	$selectt=",institute_lookup.name as namee ,institute_lookup.id as idd";
	$fromm=",institute_lookup";
	$wheree="and institute_lookup.id = `applicant`.`univ_id`  and `request`.`REQUEST_ID` = $request";
				...
				if($user_role==40)
{
	$selectt=",universty_lookup.name as namee ,universty_lookup.id as idd";
	$fromm=",universty_lookup";
	$wheree="and universty_lookup.id = `applicant`.`univ_id` and  `request`.`REQUEST_ID` = $request and status.STATUS_ID=$statusselect";
...
else if($user_role==50)
{
	$selectt=",academy_lookup.name as namee ,academy_lookup.id as idd";
	$fromm=",academy_lookup";
	$wheree="and academy_lookup.id = `applicant`.`univ_id`  and `request`.`REQUEST_ID` = $request and status.STATUS_ID=$statusselect";
...
else
{
	$selectt=",institute_lookup.name as namee ,institute_lookup.id as idd";
	$fromm=",institute_lookup";
	$wheree="and institute_lookup.id = `applicant`.`univ_id`  and `request`.`REQUEST_ID` = $request and status.STATUS_ID=$statusselect";
...
else if($user_role==50)
{
	$selectt=",academy_lookup.name as namee ,academy_lookup.id as idd";
	$fromm=",academy_lookup";
	$wheree="and academy_lookup.id = `applicant`.`univ_id`  and  `universty_lookup`.`id` =$txtarname ";
...
else
{
	$selectt=",institute_lookup.name as namee ,institute_lookup.id as idd";
	$fromm=",institute_lookup";
	$wheree="and institute_lookup.id = `applicant`.`univ_id`  and  `universty_lookup`.`id` =$txtarname ";
				...
				if($user_role==40)
{
	$selectt=",universty_lookup.name as namee ,universty_lookup.id as idd";
	$fromm=",universty_lookup";
	$wheree="and universty_lookup.id = `applicant`.`univ_id` and  `universty_lookup`.`id` =$txtarname and status.STATUS_ID=$statusselect";
...
else if($user_role==50)
{
	$selectt=",academy_lookup.name as namee ,academy_lookup.id as idd";
	$fromm=",academy_lookup";
	$wheree="and academy_lookup.id = `applicant`.`univ_id`  and  `universty_lookup`.`id` =$txtarname and status.STATUS_ID=$statusselect";
...
else
{
	$selectt=",institute_lookup.name as namee ,institute_lookup.id as idd";
	$fromm=",institute_lookup";
	$wheree="and institute_lookup.id = `applicant`.`univ_id`  and  `universty_lookup`.`id` =$txtarname and status.STATUS_ID=$statusselect ";
...
else if($user_role==50)
{
	$selectt=",academy_lookup.name as namee ,academy_lookup.id as idd";
	$fromm=",academy_lookup";
	$wheree="and academy_lookup.id = `applicant`.`univ_id`  and  `universty_lookup`.`id` =$txtarname  and `request`.`REQUEST_ID` = $request";
...
else
{
	$selectt=",institute_lookup.name as namee ,institute_lookup.id as idd";
	$fromm=",institute_lookup";
	$wheree="and institute_lookup.id = `applicant`.`univ_id`  and  `universty_lookup`.`id` =$txtarname  and `request`.`REQUEST_ID` = $request ";
				...
				if($user_role==40)
{
	$selectt=",universty_lookup.name as namee ,universty_lookup.id as idd";
	$fromm=",universty_lookup";
	$wheree="and universty_lookup.id = `applicant`.`univ_id` and  `universty_lookup`.`id` =$txtarname  and `request`.`REQUEST_ID` = $request and status.STATUS_ID=$statusselect";
...
else if($user_role==50)
{
	$selectt=",academy_lookup.name as namee ,academy_lookup.id as idd";
	$fromm=",academy_lookup";
	$wheree="and academy_lookup.id = `applicant`.`univ_id`  and  `universty_lookup`.`id` =$txtarname  and `request`.`REQUEST_ID` = $request and status.STATUS_ID=$statusselect";
...
else
{
	$selectt=",institute_lookup.name as namee ,institute_lookup.id as idd";
	$fromm=",institute_lookup";
	$wheree="and institute_lookup.id = `applicant`.`univ_id`  and  `universty_lookup`.`id` =$txtarname  and `request`.`REQUEST_ID` = $request and status.STATUS_ID=$statusselect";
