...
?>	
<form id="form1" name="form1" method="post" action="update_univ_mo3adalat2.php" onsubmit="return checkform(this);" enctype="multipart/form-data" >
<div align="center">
...
?>
  <tr hidden>
        ...
        <td>
		<div align="right"> توصية لجنة القطاع
		</div>
		</td>
      </tr>
	  <tr>
