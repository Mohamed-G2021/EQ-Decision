...
//echo '--------------------------------------'.$n;
    ...
    $sql2 = "UPDATE `request` SET `StatusID` = 6 , `updated_date_mo3adalat`= ?,`USER_ID`=? ,`fk_mo3adla`=? ,`user_role`=? ,`toketa3again_dest`=?  WHERE `FK_Applicant_serial` =?";
    $stmt2 = $con->prepare($sql2);
    $stmt2->bind_param("ssssss", $date, $myUSER_ID, $fk_mo3adla, $roleid, $toketa3again_destinationn, $serallll);
//echo"ggggg";
    $stmt2->execute();
