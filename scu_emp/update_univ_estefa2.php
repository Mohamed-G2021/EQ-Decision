...
//////////////////////////////////////////////////////	
	...
	$q="
	SELECT applicant.`Serial`,applicant.`univ_id`,applicant.`USER_ID`,applicant.`degree`,applicant.`FK_matlob`,`request`.`destination` 
...
//echo '--------------------------------------'.$n;
	...
	?>  
     <form class="form-horizontal" action="update_univ_estefa22.php" method="post" enctype="multipart/form-data">
...
<tr>
        <td >
		<div align="right">
         <input type="file" name="estefaa_dest" id="estefaa_dest" accept="application/pdf" >
        </div>
		</td>
