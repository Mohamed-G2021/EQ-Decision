...
//echo $sql;
    ...
    if ($StatusID = '6' || $StatusID = '7') {
        ...
        ?>
<form id="form1" name="form1" method="post" action="update_univ_report.php" onsubmit="return checkform(this);"
    enctype="multipart/form-data">
    <div align="center">
        <div align="center" dir="rtl">
            <h3 style="font-weight: bold;
    font-family: 'Droid Arabic Naskh', serif;">عرض التقرير</h3>
        </div>
        ...
        <table class="table table-striped">
            <tr hidden>
                <input hidden type="text" name="app_serial" id="app_serial" style="width:20em" required=""
                    value="<?php echo $app_serial; ?>" readonly />
            </tr>

            <tr hidden>
                <input hidden type="text" name="REQUEST_ID" id="REQUEST_ID" style="width:20em" required=""
                    value="<?php echo $REQUEST_ID; ?>" readonly />
            </tr>
...

        {
            ...
            while ($row = $res->fetch_array(MYSQLI_ASSOC)) {
                ...
                ?>
                            ...
                            <input hidden name="txtarnamevalue" id="txtarnamevalue" style="width:30em" required=""
...

        {
            ...
            while ($row = $res->fetch_array(MYSQLI_ASSOC)) {
                ...
                ?>
                <option value="<?php echo $id ?>"><?php echo $name ?></option>
                <input hidden name="txtarnamevalue" id="txtarnamevalue" style="width:20em" required=""
                    value="<?php echo $name; ?>" readonly />
                <?php
}
    ...
    <?php } else if ($user_role == 30) //instidute

        {
            ...
            while ($row = $res->fetch_array(MYSQLI_ASSOC)) {
                ...
                ?>
    <option value="<?php echo $id ?>"><?php echo $name ?></option>
    <input hidden name="txtarnamevalue" id="txtarnamevalue" style="width:20em" required="" value="<?php echo $name; ?>"
        readonly />
    <?php
}
    ...
    <tr>
        <td dir="rtl">
            <div align="right">
                <input type="text" name="txtorg" id="txtorg" style="width:20em" class="form-control" required=""
                    value="<?php echo $degree; ?>" readonly oninvalid="this.setCustomValidity('يجب إدخال اسم التخصص')"
    ...
    <tr>
        ...
        while ($row = $res->fetch_array(MYSQLI_ASSOC)) {
            ...
            ?>
                    ...
                    <input hidden name="dplgovname" id="dplgovname" style="width:20em" required=""
                        value="<?php echo $matlob_NAME; ?>" readonly />
                    <?php
}
...
//if(1=1)
    ...
    <div align="center">
        <?php  if($FK_matlob == 1 || $FK_matlob == 2) { ?>
<input type="submit" name="action" value="إسناد لجنة معادلات (موافقة)"
            style="width:13em ;height:2em;font-size:18px;" class="btn btn-info stylee" />
            <input type="submit" name="action" value="ارجاع الطلب للجنة القطاع"
            style="width:13em ;height:2em;font-size:18px;" class="btn btn-info stylee" />
      <?php } else{ ?>
<input type="submit" name="action" value="موافقة"
            style="width:13em ;height:2em;font-size:18px;" class="btn btn-info stylee" />
            <input type="submit" name="action" value="ارجاع الطلب للجنة القطاع"
            style="width:13em ;height:2em;font-size:18px;" class="btn btn-info stylee" />
    <?php  } ?>
        
        <input type="submit" name="action" value="يوجد إستيفاء" style="width:9em ;height:2em;font-size:18px;"
...
=
new
Spry.Widget.ValidationTextField("sprytextfield12");
var
spryselect4
=
new
Spry.Widget.ValidationSelect("spryselect4");
var
spryselect5
=
new
Spry.Widget.ValidationSelect("spryselect5");
var
spryselect6
=
new
Spry.Widget.ValidationSelect("spryselect6");
var
spryselect8
=
new
Spry.Widget.ValidationSelect("spryselect8");
var
spryselect9
=
new
Spry.Widget.ValidationSelect("spryselect9");
var
spryselect10
=
new
Spry.Widget.ValidationSelect("spryselect10");
//-->
</script>
<script type="text/javascript">
//<![CDATA[
