...
<form id="form1" name="form1" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" onsubmit="return checkform(this);">
...

{
    ...
    ?>
            ...
            <?php } else if ($user_role == 50) //acadmy

{
    ...
    ?>
            ...
            <?php } else if ($user_role == 60) //instidute

{
    ...
    ?>
            ...
            <?php }else if ($user_role == 12) //technological university
...
<?php
include "include_emp_search_result3.php";
