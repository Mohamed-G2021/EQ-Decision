...
$q = "
	SELECT applicant.`Serial`,applicant.`univ_id`,applicant.`user_role`,applicant.`USER_ID`,applicant.`degree`,applicant.`FK_matlob`,applicant.`fk_degree`,request.StatusID ,request.REQUEST_ID FROM `applicant`,request
			where
...
if ($n > 0) {
    if ($row = $res->fetch_array(MYSQLI_ASSOC)) {
        ...
        ?>
    <form class="form-horizontal" action="update_keta3.php" method="post" enctype="multipart/form-data">
...
if ($STATUS_ID == '2') {
                ...
                <td dir="rtl">
                    <div align="right">
                        <select name="keta3" id="keta3" required>
                            <option value="-1">اختر لجنة القطاع</option>
                            <?php
        ...
        ?>
            ...
            <tr>
                ...
                <td>
                    <div align="right"> خطاب أمين المجلس الأعلى للجامعات
                    </div>
                </td>
            </tr>
            <tr>
    ...
    function validatenameff() {
        ...
        if (txtarname.length == 0) {
            ...
            if (txtorg.length == 0) {
                ...
                var status_id = document.getElementById("txtstatusid").value;

                if (status_id == 2) {
                    var keta3 = document.getElementById("keta3").value;
                    if (keta3 == -1) {
                        var strr = "يرجى اختيار القطاع"
                        alert(strr);
                    } else {
                        var pattern = /^[\u0621-\u064A ]+$/;
                        ...
                        if (result2) {
                            ...
                            if (document.getElementById('myfile').files.length === 0) {
                                var strr = "يرجى رفع خطاب أمين المجلس الأعلى للجامعات"
                                alert(strr);
                            } else {
                                ...
                                if (fileType3 != 'application/pdf') {
                                    var strr = " الخطاب يجب ان يكون pdf"
                                    alert(strr);
                                } else {
                                    if ((fileSize3 / 1048576) > 5) {
                                        var strr = "الخطاب يجب ان لا يزيد حجمه عن 5 ميجا"
                                        alert(strr);
                                    } else {
                                        form.submit();
                                    }
