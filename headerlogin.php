...
<div class="container">
  <div class="row">
    <div class="col-sm-12">
<center>      <a href="logins.php">
      <img class="img-responsive" src="images/p.jpg" width="1200"  /></a>
      </center> 
    </div>
  </div>
  <div class="row">
  ...
  <div class="container-fluid">
    ...
    margin-right: -14px;">
       <li> <a  class="active stylee" href="Home.php">الصفحة الرئيسية</a></li>
     <li> <a  class="active stylee" href="logins.php">دخول النظام</a></li>
