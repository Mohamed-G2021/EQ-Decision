...
//////////////////////////////////////////////////////	
	...
	$q="
	SELECT applicant.`Serial`,applicant.`univ_id`,applicant.`USER_ID`,applicant.`degree`,applicant.`FK_matlob`,request.destination,`applicant`.`user_role` ,`request`.`karar`
...
<!------------------------------------------------------------------------------------------------------------>
      ...
      <tr>
        <td dir="rtl"><div align="right">
          <input type="text" name="txtes" id="txtes" style="width:20em ;height:20em;"   maxlength="50000" required=""  value="<?php echo $karar; ?>"  
