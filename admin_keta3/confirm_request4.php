...
$extinsion=".pdf";
$new="new";
$filename=$REQUEST_ID.$new.$extinsion;
//$filename=$arname.$ffff.$extinsion;
    $destinationn_new = '../uploads/'.$filename;
 $destinationn_delete = '../uploads/delete/'.$filename;
...
$destinationn_deletee = '../uploads/delete/'.$filename;
    // get the file extension
  //  $extension = pathinfo($filename, PATHINFO_EXTENSION);
...
?>
<form id="form1" name="form1" method="post" action="emp_edit_result4.php" onsubmit="return checkform(this);" enctype="multipart/form-data" >
...
<td>
		...
		<input type="submit" name="btnreset" id="btnreset" value="إلغاء تعديل مره اخرى" formaction="not_confirm3.php" style="width:6em ;height:2em;"/>
		</td>
		<td>
