...
?>	
<form id="form1" name="form1" method="post" action="confirm_request4.php" onsubmit="return checkform(this);" enctype="multipart/form-data" >
<div align="center">
...
echo"<script>self.location='index.php'</script>"; 
	  ...
	  <div align="center">
		<input type="reset" name="btnreset" id="btnreset" value="الغاء التعديل" style="width:6em ;height:2em;"/>
