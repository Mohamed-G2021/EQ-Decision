...
echo"<br>";
	...
	if($user_role == 150){
		$where_role=" and (institute_lookup.institute_role = 31 OR institute_lookup.institute_role = 32)";
	}
...
`request`.`fk_session_id`,institute_lookup.id as idd,institute_lookup.name as namee
FROM applicant , request $fromm ,matlob,status,institute_lookup
where 
...
and `applicant`.`user_role`=30
and institute_lookup.id = applicant.univ_id
 $wheree $where_role
