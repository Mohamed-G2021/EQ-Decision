...
//echo "yes";
//unlink($destination);
copy($destinationn2, $destinationn_deletee);
...
*/
$u="UPDATE `request` SET `StatusID`=7
...
$stmt = $con->prepare($u);
$stmt->bind_param("sssss",$keta3_id,$destinationn2,$updated_date_keta3,$acknowledgement,$Serial);
$stmt->execute();
...
$afrowlog=$stmtlog->affected_rows; 
 ...
 //// create user session 
  ...
  echo '<div id="myDiv" align="center" class="style1" style="color:#67C404;"  >
        <h2> لقد تم تعديل الملف لرقم طلب <u>' . $REQUEST_ID.'</u> </h2>
